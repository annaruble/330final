...
def hello():
    ...
    res3 = OrderedDict([('Jan','Jan'),('Feb','Feb'),('Mar','Mar'),('Apr','Apr'),('May','May'),('June','June'),('July','July'),('Aug','Aug'),('Sep','Sep'),('Oct','Oct'),('Nov','Nov'),('Dec','Dec')])
...
def procform():
    ...
    db = records.Database('postgresql://schuna05:@knuth.luther.edu/movies')
    res = db.query('select * from release_date where country = :country and year = :year and month = :month limit 10', country = countryx, year =yearx, month = res3[monthx])
